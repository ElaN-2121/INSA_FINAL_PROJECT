...
import { Home, Building2, UserPlus, ShieldCheck, LogOut, UserCircle } from 'lucide-react';
...
const navLinks = [
  ...
  { to: '/create-admin', label: 'Create Admin', icon: <UserPlus size={18} /> },
  { to: '/security-demo', label: 'Security Demo', icon: <ShieldCheck size={18} /> },
];
