  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-700">Admin Portal</p>
        <h2 className="mt-4 text-3xl font-semibold text-slate-900">Administrator Sign In</h2>
