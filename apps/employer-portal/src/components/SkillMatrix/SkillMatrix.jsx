...
const PUBLIC_LEADERBOARD_URL = 'http://localhost:5174/leaderboard';
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-gray-600">
            See which universities produce the most employer-verified graduates and which fields are most in demand
          </p>
        </div>
