  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-700">User Wallet</p>
        <h2 className="mt-4 text-3xl font-semibold text-slate-900">Sign in to EthioCred</h2>
        <p className="mt-2 text-sm text-slate-500">Access your digital credentials and verification requests.</p>
      </div>
